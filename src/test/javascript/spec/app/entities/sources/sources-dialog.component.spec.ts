...
import { SourcesDialogComponent } from '../../../../../../main/webapp/app/entities/sources/sources-dialog.component';
...
import { LibraryRegistryService } from '../../../../../../main/webapp/app/entities/library-registry';

describe('Component Tests', () => {

    describe('Sources Management Dialog Component', () => {
        let comp: SourcesDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(SourcesDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'sourcesListModification', content: 'OK'});
