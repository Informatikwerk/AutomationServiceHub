...
public class NodesResourceIntTest {
    ...
    public void setup() {
        ...
        final NodesResource nodesResource = new NodesResource(nodesRepository, nodesService);
    ...
    public void createNodes() throws Exception {
        ...
        assertThat(testNodes.getName()).isEqualTo(DEFAULT_NAME);
    }
    ...
    public void updateNodes() throws Exception {
        ...
        assertThat(testNodes.getName()).isEqualTo(UPDATED_NAME);
    }
