...
To optimize the AutomationServiceHub application for production, run:
...
Then navigate to [http://localhost:7778](http://localhost:7778) in your browser.
